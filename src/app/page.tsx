...
export default function home() {
  const vm :  ReturnType<typeof useMutationVM> = useMutationVM();
  ...
  return (
      ...
      <Table columns={getMutationColumns(vm)} data={vm.mutations} isLoading={vm.isLoading} title="Mutasi" isFiltering={vm.isFiltering} onReset={vm.handleReset} />
